...
The regular expression implementation has a method \\ \inline{eval(l1: Lang[T], l2: Lang[T]): Lang[T]} that takes two languages as parameters and evaluates the value of the regular expression with respect to it.
